            ...
            <div class="container">
                <div class="tmain1-content">
                    <div class="tmain1-img anime-left">
                        <img id="trainercard-img" src="img/t2.jpg" alt="">
                    </div>
                    <div class="tmain1-text anime-right">
                        ...
                        <div id="trainercard-description">
                            <p>With a heart wired for adrenaline, I seize each day with unwavering enthusiasm for
                                adventure. Dawn breaks, and I greet it with open arms, ready to conquer the challenges
                                it brings. These pursuits aren't just leisurely pastimes; they're the very fabric of my
                                existence, offering fresh perspectives with each pulse-pounding experience. Here's to
                                forging ahead, embracing the unknown, and crafting unforgettable memories!
                            </p>
                        </div>
                        <br> <br>
                        <div class="ticon-text">
                            ...
                            <p id="trainercard-specialties">Elena Marwood</p>
                        </div>
                        <br>
