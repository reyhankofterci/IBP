            ...
            <div class="container">
                <div class="main1-content">
                    ...
                    <div class="main1-text anime-right">
                        ...
                        <p>The bigger the wave, the better the ride. Some surfers will ride waves up to 50 feet in
                            height! Staying on the surfboard is critical, because a bad wipeout can be ugly.
                        </p>
                        <br> <br>
                        <div class="icon-text">
                            <div id="mainikon">
