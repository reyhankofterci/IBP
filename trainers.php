            ...
            <div class="container">
                <div class="tmain1-content">
                    <div class="tmain1-img anime-left">
                        <img id="trainercard-img" src="img/t3.jpg" alt="">
                    </div>
                    <div class="tmain1-text anime-right">
                        <h4>Evan Crossfield</h4>
                        <div id="tmain1ikon">
                            <i class="fa-solid fa-star"></i>
                        </div>
                        <div id="trainercard-description">
                            <p>As an adrenaline-loving athlete, I like to live every moment of my life full of adventure.
                                Every new day means a new challenge and excitement. These sports are a part of my life, and
                                each of them gives me a different perspective. See you in new adventures!
                            </p>
                        </div>
                        <br> <br>
                        <div class="ticon-text">
                            ...
                            <p id="trainercard-specialties">Sky Diving, Bungee Jumping, Paragliding</p>
                        </div>
                        <br>
        ...
        <div class="owl-carousel owl-theme">
            ...
            <div class="trainercard item">
                ...
                <div class="trainercard-content">
                    ...
                    <button class="trainercard-button" onclick="window.location.href='trainers.php'">Explore Now</button>
                </div>
            </div>
            ...
            <div class="trainercard item">
                ...
                <div class="trainercard-content">
                    ...
                    <button class="trainercard-button" onclick="window.location.href='trainers2.php'">Explore Now</button>
                </div>
            </div>
            ...
            <div class="trainercard item">
                ...
                <div class="trainercard-content">
                    ...
                    <button class="trainercard-button" onclick="window.location.href='trainers3.php'">Explore Now</button>
                </div>
            </div>
            ...
            <div class="trainercard item">
                ...
                <div class="trainercard-content">
                    ...
                    <button class="trainercard-button" onclick="window.location.href='trainers4.php'">Explore Now</button>
                </div>
            </div>
            ...
            <div class="trainercard item">
                ...
                <div class="trainercard-content">
                    ...
                    <button class="trainercard-button" onclick="window.location.href='trainers5.php'">Explore Now</button>
                </div>
            </div>
            ...
            <div class="trainercard item">
                ...
                <div class="trainercard-content">
                    ...
                    <button class="trainercard-button" onclick="window.location.href='trainers6.php'">Explore Now</button>
                </div>
            </div>
            ...
            <div class="trainercard item">
                ...
                <div class="trainercard-content">
                    ...
                    <button class="trainercard-button" onclick="window.location.href='trainers7.php'">Explore Now</button>
                </div>
            </div>
        </div>
    </section>
