            ...
            <div class="container">
                <div class="tmain1-content">
                    <div class="tmain1-img anime-left">
                        <img id="trainercard-img" src="img/t4.jpg" alt="">
                    </div>
                    <div class="tmain1-text anime-right">
                        ...
                        <div id="trainercard-description">
                            <p>As a fervent seeker of thrills, I embrace every second with an insatiable hunger for
                                adventure. Each sunrise heralds a cascade of new challenges, fuelling my zest for life.
                                These activities aren't mere hobbies; they're the essence of my being, providing unique
                                insights at every turn. Join me as I embark on an odyssey of boundless excitement and
                                discovery!
                            </p>
                        </div>
                        <br> <br>
                        <div class="ticon-text">
                            ...
                            <p id="trainercard-specialties">Skiing & Snowboarding, Downhill Mountain Biking</p>
                        </div>
                        <br>
