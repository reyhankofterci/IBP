            ...
            <div class="container">
                <div class="tmain1-content">
                    <div class="tmain1-img anime-left">
                        <img id="trainercard-img" src="img/t1.jpg" alt="">
                    </div>
                    <div class="tmain1-text anime-right">
                        ...
                        <div id="trainercard-description">
                            <p>Being an enthusiast of adrenaline-pumping activities, I thrive on embracing each moment
                                with an adventurous spirit. Every dawn brings forth a fresh set of challenges, igniting
                                my passion for excitement. These sports aren't just pastimes; they're integral to my
                                very existence, offering diverse perspectives with each exhilarating endeavor. Here's to
                                new horizons and endless adventures!
                            </p>
                        </div>
                        <br> <br>
                        <div class="ticon-text">
                            ...
                            <p id="trainercard-specialties">Scuba Diving, Rafting, Surfing</p>
                        </div>
                        <br>
