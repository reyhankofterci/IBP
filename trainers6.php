            ...
            <div class="container">
                <div class="tmain1-content">
                    <div class="tmain1-img anime-left">
                        <img id="trainercard-img" src="img/t6.jpg" alt="">
                    </div>
                    <div class="tmain1-text anime-right">
                        <h4>Nina Blackwood</h4>
                        <div id="tmain1ikon">
                            <i class="fa-solid fa-star"></i>
                        </div>
                        <div id="trainercard-description">
                            <p>In the realm of adventure, I am a fervent explorer, ready to embrace each moment with
                                unbridled enthusiasm. With the dawn of every new day comes a fresh array of challenges,
                                inviting me to push beyond my limits. These pursuits aren't just recreational; they are
                                the essence of my being, offering diverse perspectives and endless thrills. Here's to
                                embarking on new journeys, where every twist and turn promises excitement and discovery!
                            </p>
                        </div>
                        <br> <br>
                        <div class="ticon-text">
                            ...
                            <p id="trainercard-specialties">Scuba Diving, Rafting, Surfing, Bungee Jumping, Sky Diving
                            </p>
                        </div>
                        <br>
