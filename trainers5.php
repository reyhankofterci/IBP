            ...
            <div class="container">
                <div class="tmain1-content">
                    <div class="tmain1-img anime-left">
                        <img id="trainercard-img" src="img/t5.jpg" alt="">
                    </div>
                    <div class="tmain1-text anime-right">
                        <h4>Jordan Fenwick</h4>
                        <div id="tmain1ikon">
                            <i class="fa-solid fa-star"></i>
                        </div>
                        <div id="trainercard-description">
                            <p>A true adrenaline junkie at heart, I approach life with an unyielding thirst for
                                adventure. Every sunrise paints a canvas of new opportunities, beckoning me to push the
                                limits of excitement. These activities aren't mere hobbies; they're integral to my
                                identity, providing unique insights with every adrenaline-fueled moment. Join me as I
                                dive headfirst into the unknown, eager to explore and conquer the challenges that lie
                                ahead!
                            </p>
                        </div>
                        <br> <br>
                        <div class="ticon-text">
                            ...
                            <p id="trainercard-specialties">Scuba Diving, Rafting, Surfing, Downhill Mountain Biking</p>
                        </div>
                        <br>
