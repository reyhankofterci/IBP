            ...
            <div class="container">
                <div class="main1-content">
                    ...
                    <div class="main1-text anime-right">
                        <h4>SKIING&SNOWBOARDING</h4>
                        <div id="main1ikon">
                            <i class="fa-solid fa-star"></i>
                        </div>
                        <p>Here’s the gist. Make it to the top of a treacherous, ungroomed, snow covered mountain (often
                            via helicopter) and ride it to the bottom without tumbling into a nasty spill, or a raging
                            avalanche, or any other type of life threatening obstacle. Any takers?
                        </p>
                        <br> <br>
                        <div class="icon-text">
                            <div id="mainikon">
