            ...
            <div class="container">
                <div class="main1-content">
                    ...
                    <div class="main1-text anime-right">
                        ...
                        <p>Some might not consider scuba diving to be an extreme sport. But think about it, you’re 100+
                            feet underwater and the only thing keeping you alive is that tank of oxygen strapped to your
                            back. Not to mention all of the creatures lurking below… pretty intense.
                        </p>
                        <br> <br>
                        <div class="icon-text">
                            <div id="mainikon">
