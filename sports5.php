            ...
            <div class="container">
                <div class="main1-content">
                    ...
                    <div class="main1-text anime-right">
                        ...
                        <p>Using an inflatable raft or kayak to navigate choppy “whitewater” that has an unstable,
                            turbulent current. Rafters risk hitting sharp rocks, unexpected steep waterfalls, and being
                            thrown from the raft. Hang on tight!
                        </p>
                        <br> <br>
                        <div class="icon-text">
                            <div id="mainikon">
